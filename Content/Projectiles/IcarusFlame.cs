...
namespace DreamMod.Content.Projectiles
{
    public class IcarusFlame : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            shader.setProperties([Color.Orange.ToVector3(),Color.Red.ToVector3(),Color.Wheat.ToVector3()], TextureAssets.Extra[193].Value,TextureAssets.Projectile[Type].Value, shaderData: new Vector4(Projectile.rotation, Projectile.timeLeft, Projectile.Size.X * 5, Projectile.Size.Y));
            shader.apply();
            ...
            shader.setProperties([Color.Orange.ToVector3(),Color.Red.ToVector3(),Color.Wheat.ToVector3()], TextureAssets.Extra[193].Value,TextureAssets.Projectile[Type].Value, shaderData: new Vector4(Projectile.rotation, Projectile.timeLeft, Projectile.Size.Length(), explosionAlpha));
            shader.apply();
